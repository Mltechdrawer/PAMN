...
- El usuario paga antes de descargar (por ejemplo, **1,99 €**).  
- Google o Apple se quedan con ~15–30 % de comisión.  
- El desarrollador recibe el resto (~**1,40 €** por descarga).

En este modelo, una caída en descargas **impacta directamente** en los ingresos.

**Ejemplo:**

- 20.000 descargas/mes × 1,99 € = **39.800 € brutos**.  
- Si bajas a 3.000 descargas/mes → apenas **5.970 €**.  
- **Pérdida: ~34.000 €/mes.**
...
- Cada usuario ve anuncios (intersticiales, banners o vídeos).  
- Se gana por impresiones o clics (CPM o CPC).  
- Más descargas = más usuarios activos = más impresiones = más ingresos.

**Ejemplo típico de app con anuncios:**

- CPM (coste por mil impresiones) ≈ 2 €  
- Cada usuario ve unas 200 impresiones/mes → 0,40 €/usuario.  
- Si pierdes 100.000 usuarios activos → **pierdes 40.000 € mensuales.**
...
- Tasa de conversión típica: **2–5 %**.  
- Valor medio por usuario que paga (ARPPU): **10–20 €**.  
- Por tanto, las descargas aumentan el **embudo de conversión**.

**Ejemplo:**

- 100.000 nuevos usuarios/mes × 3 % × 10 € = **30.000 €**.  
- Si caes en ranking y solo consigues 15.000 usuarios nuevos, pasas a **4.500 €**.  
- **Pérdida: ~25.000 € mensuales.**
...
- Más descargas → más pruebas → más conversiones a pago mensual o anual.  
- Si la app baja de visibilidad, la entrada al embudo se reduce.

**Ejemplo:**

- Conversión a suscripción: 1 %.  
- Precio: 5 €/mes.  
- 100.000 descargas → 1.000 suscriptores = **5.000 €/mes.**  
- 10.000 descargas → 100 suscriptores = **500 €/mes.**  
- **Pérdida: 4.500 €/mes.**
...
> Por eso, cuando una app cae de ranking y pierde visibilidad, los ingresos bajan aunque la app siga siendo gratuita.
